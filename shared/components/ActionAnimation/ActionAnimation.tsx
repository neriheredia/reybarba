...
const ActionAnimation = ({ action, setAction = () => {} }: LikeDislikeProps ) => {
    ...
    return(
        <View style={{ position: 'absolute', width: '100%', height: '90%' }}>
            {showLike && 
                <Animated.View style={{transform: [{scale: animatedScale}], position: "absolute", top: 0, right: 0, left: 0, bottom: 0, justifyContent: "center", alignItems: "center", zIndex: 9999, elevation: 5}}>
                    <Icon name="heart" color={colors.blue} size={64}/>
                </Animated.View>
            }
            {showNotLike && 
                <Animated.View style={{transform: [{scale: animatedScale.interpolate({inputRange: [0,1],outputRange: [1,0]})}], position: "absolute", top: 0, right: 0, left: 0, bottom: 0, justifyContent: "center", alignItems: "center", zIndex: 9999, elevation: 5}}>
