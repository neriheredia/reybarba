...
const ButtonMedium = ({title, color = colors.buttonPrimary, onPress=() => console.log("pressed"), disabled=false, transparent=false}: ButtonMediumProps) => {

    
    return (
        <Pressable onPress={onPress} disabled={disabled}>
            <View style={[styles.container, {backgroundColor: color},disabled && {backgroundColor: colors.buttonSecondary}]}>
