          ...
          <Pressable onPress={() => {
            navigator.navigate("Descuentos")
              ...
              <View style={{borderTopLeftRadius: 10}}>
                  <Image source={focused ? images.discountOrange : images.discountWhite}
                    resizeMode="contain"
                    resizeMethod="scale"
                    style={{
          ...
          tabBarIcon:({focused}) => (
            <Pressable onPress={() => {
              navigator.navigate("Home")
                ...
                <View style={{borderTopLeftRadius: 10}}>
                    <Image source={focused ? images.logoNaranja : images.logo}
                      resizeMode="contain"
                      resizeMethod="scale"
                      style={{
          ...
          tabBarIcon:({focused}) => (
            <Pressable onPress={() => {
              navigator.navigate("Turnos")
                ...
                <View style={{borderTopLeftRadius: 10}}>
                    <Image source={focused ? images.calendarIconOrange : images.calendarIconWhite}
                      resizeMode="contain"
                      resizeMethod="scale"
                      style={{
                        width: moderateScale(22,1.5),
