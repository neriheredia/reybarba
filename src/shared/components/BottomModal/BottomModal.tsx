...
const BottomModal = ({
  ...
  return (
    <Modal animationType="none" transparent style={styles.messageContainer}>
      <Pressable
        style={{ flex: 1, backgroundColor: "rgba(43, 43, 43,.5)" }}
        onPress={onPress}
      >
        ...
        >
          <View
            style={{
              ...
              borderTopRightRadius: moderateScale(30, 1.1),
              borderTopLeftRadius: moderateScale(30, 1.1),
              alignItems: "center",
            }}
          >
            <Pressable
              style={({ pressed }) => ({
                ...
                height: 10,
                backgroundColor: "rgba(210, 210, 214,.46)",
                alignSelf: "center",
                width: "20%",
                marginVertical: moderateScale(24, 1.1),
                borderRadius: 16,
              })}
              onPress={onPress}
            />
            ...
            <View style={[wrapperButtonStyles, { flexDirection: "row" }]}>
              {acceptButton && (
                <Button title={acceptButtonLabel} onPress={onPressAccept} />
              )}
              {cancelButtom && (
                <Button title={cancelButtonLabel} onPress={onPressAccept} />
              )}
            </View>
          </View>
        </Animated.View>
