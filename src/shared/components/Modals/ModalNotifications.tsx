  ...
  return (
    <Modal transparent animationType="slide">
      <View style={styles.container}>
        ...
        <Pressable
          onPress={buttons ? () => {} : closeModal}
          style={[
            styles.modal,
            {
              top: verticalModerateScale(height / 4.8, 1),
              paddingBottom: buttons ? 0 : moderateScale(20),
            },
          ]}
        >
          <View style={{ position: "relative" }}>
            ...
            {closedButton && (
              <Pressable
                ...
                style={{
                  position: "absolute",
                  right: moderateScale(16, 1.1),
                  top: moderateScale(16, 1.1),
                }}
              >
                <Icon
                  color={colors.darkGray}
                  name="close"
                  size={moderateScale(20, 1.1)}
                />
              </Pressable>
            )}
            ...
            <View
              style={[
                styles.textWrapper,
                noIcon && gif ? styles.paddingTopTextWrapper : {},
              ]}
            >
              {mainTitle ? (
                <Text
